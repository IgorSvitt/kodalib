...
public class CountryService: ICountryService
{
    ...
    public IBaseResponce<Country> GetCountryByName(string name)
    {
        var baseResponce = new BaseResponce<Country>();
    ...
    public IBaseResponce<CountryViewModel> CreateCountry(CountryViewModel countryViewModel)
    {
        var baseResponce = new BaseResponce<CountryViewModel>();

        try
        {
            var countryName = _countryRepository.GetByName(countryViewModel.Name);
